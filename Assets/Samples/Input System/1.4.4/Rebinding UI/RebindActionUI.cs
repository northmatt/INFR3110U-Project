    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                // Ignoring mouse clicks when rebinding keys
                // Preventing accendental mouse click
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (CheckDuplicate(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool CheckDuplicate(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    Debug.Log("Duplicate key binding found: " + newBinding.effectivePath);
                    return true;
                }
            }
